...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/27 15:16:44 by fwechsle          #+#    #+#             */
/*   Updated: 2024/03/05 20:44:27 by fwechsle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_mlx_bonus(t_mlx *data)
{
	...
	data->prev_time = get_time();
	get_images(data);
	events(data);
	mlx_loop_hook(data->mlx, buffer_drawing, data);
	mlx_loop(data->mlx);
